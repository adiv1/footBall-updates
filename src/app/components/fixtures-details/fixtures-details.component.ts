...
export class FixturesDetailsComponent implements OnInit {
  ...
  public columnDefs: any = [
    {
      headerName: '',
      field: 'team.logo',
      cellRenderer: (params: any) => this.getImages(params),
    },
    ...
    { headerName: '', field: 'score.fulltime.away' },
    {
      ...
      cellRenderer: (params: any) => this.getAwayImages(params),
    },
  ...
  getImages(params: any) {
    ...
    return `<img style="height:14px; width:14px" src=${params.data.teams.home.logo} />`;
  }

  getAwayImages(params: any) {
    console.log(params);

    return `<img style="height:14px; width:14px" src=${params.data.teams.away.logo} />`;
  }
